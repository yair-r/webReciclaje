<?php session_start();
	...
	include "./CC/crud.php";
	$crud = new Crud();
	$datos = $crud->mostrarDatosVi();
    include "/xampp/htdocs/Fusion/navbar.php";
?>
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Revision de Registros del Reciclaje de Vidrio</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">En este apartado se puede revisar los diversos registros realizados sobre el reciclaje de vidrio</li>
                </ol>
                <div class="row">
                    <div class="col">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="./VEvi.php" method="POST">
                                        ...
                                        <td class="text-center">
                                            <form action="./VDvi.php" method="POST">
                                                <input type="text" hidden value="<?php echo $item->_id ?>" name="id">
                    ...
                    <div>
                        <a href="./ExVi.php" class="btn btn-success">
