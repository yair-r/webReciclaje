<?php session_start();
	...
	include "./CC/crud.php";
	$crud = new Crud();
	$datos = $crud->mostrarDatosRP();
    include "/xampp/htdocs/Fusion/navbar.php";
?>
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Revision de Registros del Reciclaje de Residuos Peligrosos</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">En este apartado se puede revisar los diversos registros realizados sobre el reciclaje de residuos peligrosos</li>
                </ol>
                <div class="row">
                    <div class="col">
                        <a class="btn btn-primary " href="./VArp.php" role="button"> Agregar nuevo registro</a>
                        <hr>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Tabla de registros de reciclaje Vidrio
                            </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="./VErp.php" method="POST">
                                        ...
                                        <td class="text-center">
                                            <form action="./VDrp.php" method="POST">
                                                <input type="text" hidden value="<?php echo $item->_id ?>" name="id">
                    ...
                    <div>
                        <a href="./Exrp.php" class="btn btn-success">
