...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Revision de Registros del Reciclaje de Material Organico</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">En este apartado se puede revisar los diversos registros realizados sobre el reciclaje de material Organico</li>
                </ol>
                <div class="row">
                    <div class="col">
                        <a class="btn btn-primary " href="./VAorg.php" role="button"> Agregar nuevo registro</a>
                        <hr>
                        <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="./VEorg.php" method="POST">
                                        ...
                                        <td class="text-center">
                                            <form action="./VDorg.php" method="POST">
                                                <input type="text" hidden value="<?php echo $item->_id ?>" name="id">
                    ...
                    <div>
                        <a href="./Exorg.php" class="btn btn-success">
