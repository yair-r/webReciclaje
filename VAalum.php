...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Agregar un nuevo registro</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Favor de llenar los campos necesarios para realizar el registro</li>
                </ol>
                <div class="row">
                    <div class="col">
                        <hr>
                        <div class="card mb-4">
                        <div class="card-body">
                            <form action="./PIalum.php" method="post">
